...
trainer_client = TrainerClient(namespace="hosein", config_file="~/.kube/kubeflow.yaml")
...
job_id = trainer_client.train(
    trainer=CustomTrainer(
        ...
        resources_per_node={
            "cpu": 1,
            "memory": "3Gi",
            "nvidia.com/gpu.shared": 1, # Comment this line if you don't have GPUs.
        }
    ),
    runtime=trainer_client.get_runtime("torch-distributed"), 
    custom_job_labels={"add-gpu-toleration": "true"},
)
print(job_id)
